...
rm -rf ~/.pybombs
pybombs recipes add gr-recipes git+https://{{ site.host }}/pybombs/recipes/gr-recipes.git
pybombs recipes add gr-etcetera git+https://{{ site.host }}/pybombs/recipes/gr-etcetera.git
