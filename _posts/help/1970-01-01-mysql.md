...
baseurl=https://{%endraw%}{{ site.hostname }}{%raw%}/mysql/yum/mysql-connectors-community-{{release_name}}/
enabled=1
gpgcheck=1
...
baseurl=https://{%endraw%}{{ site.hostname }}{%raw%}/mysql/yum/mysql-tools-community-{{release_name}}/
enabled=1
gpgcheck=1
gpgkey=file:///etc/pki/rpm-gpg/RPM-GPG-KEY-mysql
...
baseurl=https://{%endraw%}{{ site.hostname }}{%raw%}/mysql/yum/mysql56-community-{{release_name}}/
enabled=0
gpgcheck=1
gpgkey=file:///etc/pki/rpm-gpg/RPM-GPG-KEY-mysql
...
baseurl=https://{%endraw%}{{ site.hostname }}{%raw%}/mysql/yum/mysql57-community-{{release_name}}/
enabled=1
gpgcheck=1
gpgkey=file:///etc/pki/rpm-gpg/RPM-GPG-KEY-mysql
...
baseurl=https://{%endraw%}{{ site.hostname }}{%raw%}/mysql/yum/mysql80-community-{{release_name}}/
enabled=1
gpgcheck=1
gpgkey=file:///etc/pki/rpm-gpg/RPM-GPG-KEY-mysql
