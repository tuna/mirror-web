...
#### [KiCad 镜像目录说明](https://{{ site.host }}/kicad/)
...
[KiCad Windows 版本下载](https://{{ site.host }}/kicad/windows/)
...
[OS X 版本下载](https://{{ site.host }}/kicad/osx/)
...
添加 [ArchlinuxCN](https://{{ site.host }}/help/archlinuxcn/) 镜像:
