...
deb {{if os_name|equals>ubuntu}}https{{else}}http{{/if}}://{{ site.host }}/mongodb/apt/{{os_name}} {{release_name}}/mongodb-org/stable {{repo-name}}
</script>
{%endraw%}
...
baseurl=https://{{ site.host }}/mongodb/yum/el$releasever/
gpgcheck=0
enabled=1
```
