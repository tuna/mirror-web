...
deb http://{{ site.host }}/raspbian/raspbian/ {{release_name}} main non-free contrib
deb-src http://{{ site.host }}/raspbian/raspbian/ {{release_name}} main non-free contrib

# 编辑 `/etc/apt/sources.list.d/raspi.list` 文件，删除原文件所有内容，用以下内容取代：
deb http://{{ site.host }}/raspberrypi/ {{release_name}} main ui
</script>
{% endraw %}
