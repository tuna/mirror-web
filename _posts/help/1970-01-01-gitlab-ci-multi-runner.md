...
Runner，由于官方名称发生变化，请前往 [gitlab-runner帮助页面](https://{{ site.host }}/help/gitlab-runner/)。
...
deb {{if os_name|equals>ubuntu}}https{{else}}http{{/if}}://{{ site.host }}/gitlab-ci-multi-runner/{{os_name}} {{release_name}} main
</script>
{%endraw%}
...
baseurl=https://{{ site.host }}/gitlab-ci-multi-runner/yum/{{release_name}}
repo_gpgcheck=0
gpgcheck=0
enabled=1
