...
$mirrors = array(
	...
	array('centos', '由社区维护的与RHEL完全兼容的发行版。', 'alick'),
	...
	array('epel', 'Fedora社区为RHEL等提供的额外软件包。', 'BYVoid'),
	...
	array('rpmfusion', '一个用于Fedora和RHEL等的第三方软件仓库。', 'alick'),
	array('scientific', '由美国费米实验室维护的与RHEL兼容的发行版。', 'BYVoid'),
